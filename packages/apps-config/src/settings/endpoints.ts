  ...
  return [
    {
      dnslink: 'indranet',
      info: 'indranet',
      text: t('rpc.indranet', 'Indranet', { ns: 'apps-config' }),
      textBy: t('rpc.hosted.by', 'hosted by {{host}}', { ns: 'apps-config', replace: { host: 'Selendra' } }),
      value: 'wss://rpc-testnet.selendra.org'
    },
