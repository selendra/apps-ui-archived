// Copyright 2017-2022 @selendra/apps-config authors & contributors
...
import { createCardamomRelay, createSelendraRelay } from './productionRelays';
...
export function createWsEndpoints (t: TFunction, firstOnly = false, withSort = true): LinkOption[] {
  return [
    ...
    ...createCardamomRelay(t, firstOnly, withSort),
    {
      isDevelopment: true,
      isDisabled: false,
      isHeader: true,
